...
class FrequencyStore: ObservableObject {
    ...
    private func loadPredefinedFrequencies() {
        ...
        let frequencyData: [(Int, Double, Double, Double, Int, String)] = [
            ...
            // FLTSATCOM 8
            (11, 243.990, 317.090, 73.100, 6, "FLTSATCOM 8"),
            (12, 243.995, 317.095, 73.100, 6, "FLTSATCOM 8"),
            (13, 244.000, 317.100, 73.100, 6, "FLTSATCOM 8"),
            (20, 244.090, 317.190, 73.100, 6, "FLTSATCOM 8"),
            (120, 252.150, 293.150, 41.000, 34, "FLTSATCOM 8"),
            (172, 257.140, 298.140, 41.000, 30, "FLTSATCOM 8"),
            (173, 257.150, 298.150, 41.000, 30, "FLTSATCOM 8"),
            (175, 257.190, 298.140, 40.950, 30, "FLTSATCOM 8"),
            (193, 258.650, 299.650, 41.000, 34, "FLTSATCOM 8"),
            (239, 262.150, 295.750, 33.600, 6, "FLTSATCOM 8"),
            (242, 262.300, 295.900, 33.600, 6, "FLTSATCOM 8"),
            (265, 265.550, 306.550, 41.000, 30, "FLTSATCOM 8"),
            (295, 269.950, 394.325, 24.375, 25, "FLTSATCOM 8"),
            
            // COMSATBW 1
            (98, 249.400, 300.975, 51.575, 34, "COMSATBW 1"),
            (162, 255.775, 315.100, 59.325, 34, "COMSATBW 1"),
    ...
    func getSatelliteName(for noradID: Int) -> String? {
        return SatcomReference.allSatellites.first(where: { $0.noradID == noradID })?.name
    }
